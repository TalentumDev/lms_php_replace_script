...
class core_renderer extends \core_renderer {
    ...
    public function search_box($id = false) {
        ...
        $searchicon = html_writer::tag(
            'div',
            $this->pix_icon('a/search', get_string('search', 'search'), 'moodle', array('class' => 'align-middle')),
            array('role' => 'button', 'tabindex' => 0, 'style' => 'position: relative; top: 0.4rem;')
        );
        ...
        $html = '<li class="d-none d-lg-flex nav-item">';
